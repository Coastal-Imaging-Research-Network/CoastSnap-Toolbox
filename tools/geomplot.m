...
%Plot result
subplot('position',[(marg_hor(1)+(pos_hor-1)*(axis_hor+gaps(1)))/width (height-(marg_ver(1)+pos_ver*axis_ver+(pos_ver-1)*gaps(2)))/height axis_hor/width axis_ver/height])

%print filename.eps -loose -depsc