...
site = 'blacksmiths'
photoshoptemp_dir = 'C:\Users\z2273773\Desktop\Photoshop Temp'; %Name of directory where you have saved your registered images from photoshop
...
h.FontSize = 12;
print(strrep(fname,'.jpg','_registered.jpg'),'-r400','-djpeg')
close all
end